      ...
      <div className="flex">
        ...
        <div>
          <div className="flex gap-[2rem] mt-[25px]">
            <div className="bg-[#fafafa] h-[200px] w-[240px] p-[20px] overflow-y-auto rounded-[1rem] ">
            ...
            <div className="bg-[#fafafa] h-[200px] w-[240px] p-[20px] overflow-x-auto rounded-[1rem]">
              <div className="flex justify-between">
                <div className="border border-[#e7e7e7] rounded-[50%] w-[40px] h-[40px] flex items-center justify-center align-middle">
